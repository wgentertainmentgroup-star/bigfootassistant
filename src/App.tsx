...
import { getLastCaller, requestCallerIdAccess, requestHomeShortcut, requestNotificationAccess, scheduleReminder, syncPeopleForCallerId } from './native'
...
function App() {
  ...
  if (showSetup) return <SetupWizard state={state} onChange={setState} onFinish={() => { setState(s => ({ ...s, preferences: { ...s.preferences, setupComplete: true } })); void requestHomeShortcut(); setShowSetup(false); setSection('home') }} />
